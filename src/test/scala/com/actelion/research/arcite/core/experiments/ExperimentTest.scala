...
class ExperimentTest extends FlatSpec with Matchers {
  ...
  " get URI for experiment " should " return a unique well formed uri " in {
    ...
    val expected1 = s"arcite.actelion.com/com/actelion/research/bioinfo/mock/${exp1.uid}"
    val expected2 = s"www.actelion.com/arcite/com/actelion/research/bioinfo/mock/${exp1.uid}"
